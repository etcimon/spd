...
*/
module spd.serialization;

import spd.meta.traits;
import spd.meta.uda;
...
/**
	...
	See_Also: spd.json.JsonSerializer, spd.json.JsonStringSerializer, spd.bson.BsonSerializer
*/
...
private T deserializeImpl(T, alias Policy, Serializer, ATTRIBUTES...)(ref Serializer deserializer)
{
	...
	static if (is(T == enum)) {
		...
		string name;
		T ret;
		static if (is(T == class)) ret = alloc!T;
...
/**
	...
	See_Also: spd.serialization.serializeWithPolicy
*/
